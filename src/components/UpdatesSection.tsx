import { Box, Typography, Container, Paper, List, ListItem, ListItemText, ListItemAvatar, Avatar } from '@mui/material'
...
const updates = [
  {
    ...
    description: 'Create your own unique voice profiles with our new voice creation tool.',
    date: '2023-10-15',
  ...
  },
  {
    ...
    description: 'Enhanced audio processing for clearer and more natural sounding voices.',
    date: '2023-10-10',
  ...
  },
  {
    ...
    description: 'Added 10 new voice actors to our growing library of professional voices.',
    date: '2023-10-05',
